...
public class MainActivity extends Activity {
	...
	private void getSuggestions(){
    	...
    	//String likes = "{\"user\": [{\"uid\": 111111111}], \"likes\": [{\"created_time\": 13, \"page_id\": 9}, {\"created_time\": 14, \"page_id\": 10}]}";
    	//String likes = null;
    ...
    public class GetFbInfoAsync extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... params) {
			...
			//FBInfoFetcher.getArtistInfo();
			System.out.println("CCCC: "+userLikes.toString());
